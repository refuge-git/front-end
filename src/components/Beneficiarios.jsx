...
export default function Beneficiarios() {
  ...
  const handleConfirmarPresenca = () => {
    ...
    // Aqui você pode chamar a API de presença

    setAtividades({ PRESENCA: false, BANHO: false, REFEICAO: false });
  ...
  const handleSalvarNovaAtividade = () => {
    ...
    // Aqui você pode chamar a API de criação da atividade
          ...
          return (
            <div key={i} className="beneficiarios-card">
              <div
                ...
                onClick={() => setPresencaBeneficiario(item)} // abre modal de presença
